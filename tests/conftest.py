...
# WARNING: Ensure imports from `fastapi_test` comes after this line
from fastapi_test import app, settings, db  # noqa
from fastapi_test.cli import create_user, cli  # noqa
