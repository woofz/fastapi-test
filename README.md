...
- 🎯 Entry points to execute your program using `python -m <fastapi_test>` or `$ fastapi_test` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/woofz/fastapi-test/branch/main/graph/badge.svg?token=fastapi-test_token_here)](https://codecov.io/gh/woofz/fastapi-test)
[![CI](https://github.com/woofz/fastapi-test/actions/workflows/main.yml/badge.svg)](https://github.com/woofz/fastapi-test/actions/workflows/main.yml)

Awesome fastapi_test created by woofz

## Install

from source
```bash
git clone https://github.com/woofz/fastapi-test fastapi_test
cd fastapi_test
make install
```
...
```bash
pip install fastapi_test
```

## Executing

```bash
$ fastapi_test run --port 8080
```

or

```bash
python -m fastapi_test run --port 8080
```
...
```bash
❯ fastapi_test --help
Usage: fastapi_test [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_test create-user --help
Usage: fastapi_test create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_test create-user admin admin --superuser
```
...
Run with `fastapi_test run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_test create-user`.
...
-----------------------------------------------------
fastapi_test/__init__.py              4      0   100%
fastapi_test/app.py                  16      1    94%
fastapi_test/cli.py                  21      0   100%
fastapi_test/config.py                5      0   100%
fastapi_test/db.py                   10      0   100%
fastapi_test/models/__init__.py       0      0   100%
fastapi_test/models/content.py       47      1    98%
fastapi_test/routes/__init__.py      11      0   100%
fastapi_test/routes/content.py       52     25    52%
fastapi_test/routes/security.py      15      1    93%
fastapi_test/routes/user.py          52     26    50%
fastapi_test/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_test/default.toml.
